              ...
              <div class="detail_page-infor">
                <div class="dp-i-content">
                  ...
                  <div class="dp-i-c-right">
                    ...
                    <div class="dp-i-stats">
                      ...
                      <span class="item mr-1">
                        <button data-toggle="modal" data-target="#modaltrailer" title="Preview" class="btn btn-sm btn-trailer">
                          <i class="fas fa-video mr-2"></i> Preview </button>
                      </span>
                      <span class="item mr-1">
                    ...
                    <div class="description" style="text-align: justify; ">The <strong>"Taddok"</strong> is a vibrant and culturally significant dance from the Kalinga people, often performed during fiestas and special festivities. This traditional dance features a captivating display of movement and rhythm, with men skillfully beating gongs as they skip their feet in sync with the tempo. <br>The women, dancing the <strong>"Tanggi"</strong>, gracefully move with hands wide open at shoulder level, mirroring the rhythm of the gongs while skipping around the dance area. Together, they dance in a circular formation around the plaza, occasionally adding unique patterns to break the monotony of the basic steps. <br>During major events, taddok contests are held, with dancers donning their finest traditional costumes. These competitions encourage creativity, as participants introduce variations of the steps to stand out and make the celebration even more lively and engaging. The "Taddok" not only showcases Kalinga's heritage but also brings communities together through the joy of movement and tradition. </div>
                    <div class="elements">
                      <div class="row">
                ...
                <div class="film_list-wrap">
                  <div class="flw-item">
                    <div class="film-poster">
                      ...
                      <img data-src="assets\img\dance-igorot.jpg" class="film-poster-img lazyload" title="Tadok" alt="watch-Tadok">
                      <a href="#" class="film-poster-ahref flw-item-tip" title="Tadok">
                        <i class="fa fa-play"></i>
                      </a>
                    </div>
                    <div class="film-detail film-detail-fix">
                      <h3 class="film-name">
                        <a href="video-player.php" title="Tadok">
                          <strong>Tadok</strong>
                        </a>
                      </h3>
                      <div class="fd-infor">
                  ...
                  <div class="flw-item">
                    <div class="film-poster">
                      ...
                      <a href="#" class="film-poster-ahref flw-item-tip" title="Tupayya">
                        <i class="fa fa-play"></i>
                      </a>
                    </div>
                    <div class="film-detail film-detail-fix">
                  ...
                  <div class="flw-item">
                    <div class="film-poster">
                      ...
                      <a href="#" class="film-poster-ahref flw-item-tip" title="Lablabbaan">
                        <i class="fa fa-play"></i>
                      </a>
                    </div>
                    <div class="film-detail film-detail-fix">
                  ...
                  <div class="flw-item">
                    <div class="film-poster">
                      ...
                      <a href="#" class="film-poster-ahref flw-item-tip" title="Boogie">
                        <i class="fa fa-play"></i>
                      </a>
                    </div>
                    <div class="film-detail film-detail-fix">
                  ...
                  <div class="flw-item">
                    <div class="film-poster">
                      ...
                      <a href="#" class="film-poster-ahref flw-item-tip" title="Boogie Variance">
                        <i class="fa fa-play"></i>
                      </a>
                    </div>
                    <div class="film-detail film-detail-fix">
                  ...
                  <div class="flw-item">
                    <div class="film-poster">
                      ...
                      <a href="#" class="film-poster-ahref flw-item-tip" title="Takkik">
                        <i class="fa fa-play"></i>
                      </a>
                    </div>
                    <div class="film-detail film-detail-fix">
                  ...
                  <div class="flw-item">
                    <div class="film-poster">
                      ...
                      <a href="#" class="film-poster-ahref flw-item-tip" title="Dinuyya">
                        <i class="fa fa-play"></i>
                      </a>
                    </div>
                    <div class="film-detail film-detail-fix">
                  ...
                  <div class="flw-item">
                    <div class="film-poster">
                      ...
                      <a href="#" class="film-poster-ahref flw-item-tip" title="Balliwes">
                        <i class="fa fa-play"></i>
                      </a>
                    </div>
                    <div class="film-detail film-detail-fix">
