          ...
          <div id="general-form">
            ...
            <div class="input-container" style="width: 300px">
              ...
              <select id="schoolSelect" class="input-field" onchange="showOtherInput()">
                ...
                <option value="school2"> School of Accountancy, Management, Computing and Information Studies </option>
                <option value="school3">School of Advanced Studies</option>
                <option value="school4"> School of Engineering and Architecture </option>
                <option value="school5">School of Law</option>
                <option value="school6">School of Medicine</option>
                <option value="school7"> School of Nursing, Allied Health, and Biological Sciences </option>
                <option value="school8"> School of Teacher Education and Liberal Arts </option>
