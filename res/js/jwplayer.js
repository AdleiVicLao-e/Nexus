window.jwplayer = function(t) {
    ...
    var r = n(18)
      ...
      , G = function(t, e) {
        var n, r;
        if (j && t.bind === j)
            return j.apply(t, c.call(arguments, 1));
        if (!bt(t))
            throw new TypeError;
...
, function(t, e, n) {
    ...
    var h, v, g = "ontouchstart"in window, b = "PointerEvent"in window && !r.OS.android, m = !(b || g && r.OS.mobile), y = "window", w = "keydown", j = r.Features.passiveEvents, O = !!j && {
        passive: !0
              ...
              , s = function(n) {
                ...
                t.el)
                    ...
                    t.dragged)
                        ...
                        o ? N(t, i.n, n) : (N(t, i.sb, n),
                        "touchend" !== n.type || j || R(n))
                    }
            };
...
, function(t, e, n) {
    ...
    var d = function(t, e) {
        ...
        h.volume = Object(r.A)(h.volume) ? Math.min(Math.max(0, h.volume), 100) : f.volume,
        h.mute = !!h.mute,
        h.language = d,
        h.intl = p;
        var v = i.autoPause;
        ...
        delete h.duration;
        var w = h.liveTimeout;
        null !== w && (Object(r.A)(w) ? 0 !== w && (w = Math.max(30, w)) : w = null,
        h.liveTimeout = w);
        var j, O, k = parseFloat(h.bandwidthEstimate), C = parseFloat(h.bitrateSelection);
        return h.bandwidthEstimate = Object(r.A)(k) ? k : (j = h.defaultBandwidthEstimate,
        O = parseFloat(j),
        Object(r.A)(O) ? Math.max(O, 1) : f.bandwidthEstimate),
        h.bitrateSelection = Object(r.A)(C) ? C : f.bitrateSelection,
        h.backgroundLoading = Object(r.s)(h.backgroundLoading) ? h.backgroundLoading : c.Features.backgroundLoading,
        h
    }
      , p = n(8)
      , h = n(26)
    ...
    var C = function(t, e) {
        ...
        }, f, Object(r.E)(o, ["analytics", "aspectratio", "base", "file", "height", "playlist", "sources", "width"]))),
        o.key = a,
        o.edition = s,
        o.error = c.error(),
        ...
        i = o.playlist,
        Object(r.y)(i) && i.indexOf(g) > -1 && (o.playlist = function(t, e) {
    ...
    function N(t) {
        return B(t) ? Promise.resolve() : F(t).then((function() {
            if (t.get("drm") || Object(L.b)(t.get("playlist")))
                return Object(L.d)(t.get("edition"))
        }
        )).then((function() {
    ...
    function D(t, e) {
        var n = [R(t)];
        return B(t) || n.push(Promise.resolve()),
        Promise.all(n)
    }
    function R(t) {
        var e = t.attributes
        ...
        if (n && n.code === h.a) {
            ...
            if (i > 0 && i < 4 && r && o.duration() > -7776e6)
                return new A.a("//content.jwplatform.com/libraries/".concat(r, ".js")).load().then((function() {
      ...
      , V = function(t) {
        ...
        return !Object(l.h)(n) || Object(l.f)(u) ? Promise.resolve() : new Promise((function(i) {
            return Object(l.i)(r, n).then((function(n) {
                ...
                if (!I(t)) {
                    if (!r)
                        throw new _.s(null,_.g);
                    e.localization = Object(l.a)(r, u),
                    i()
                }
            }
            )).catch((function(t) {
    ...
    Object(r.k)(U.prototype, {
        getAllItems: function() {
            ...
            return this.items.reduce((function(e, n) {
                ...
                return r && (e[n] = Object(a.serialize)(r)),
                e
            }
            ), {})
        },
    ...
    var nt = function(t) {
        ...
        this.modelShim._qoeItem = new Q.a,
        this.mediaShim = {},
        this.setup = new z(this.modelShim),
    ...
    Object(r.k)(nt.prototype, {
        ...
        init: function(t, e) {
            ...
            Object(r.k)(this.mediaShim, J.a);
            var a = t
              , c = C(Object(r.k)({}, t), u);
            c.id = e.id,
            c.setupConfig = a,
            Object(r.k)(i.attributes, c, J.b),
            ...
            this.setup.start(e).then((function(t) {
                ...
                n.setup && function(t, e, n) {
                    Promise.resolve().then((function() {
                        ...
                        if (!o) {
                            var u = Object($.a)(t, r);
                            $.a.cloneIcon && u.querySelector(".jw-icon").appendChild($.a.cloneIcon("error")),
                            ot(t, u)
                        }
                        i.set("errorEvent", r),
                        i.set("state", S.mb),
...
, function(t, e, n) {
    "use strict";
    var r, i = n(62), o = n(5), u = n(6), a = [], c = [], s = [], l = {}, f = "screen"in window && "orientation"in window.screen, d = o.OS.android && o.Browser.chrome, p = !1;
    function h(t, e) {
...
, function(t, e, n) {
    ...
    var Q = function(t) {
        var e, n;
        if (t ? "string" == typeof t ? (e = W(t)) || (n = document.getElementById(t)) : "number" == typeof t ? e = v.a[t] : t.nodeType && (e = W((n = t).id || n.getAttribute("data-jwplayer-id"))) : e = v.a[0],
        e)
            return e;
        if (n) {
            var r = new H(n);
    ...
    Object(r.k)(pt, nt),
    X(pt),
    "function" == typeof dt.define && dt.define.amd && dt.define([], (function() {
        return pt
    }
    ));
    var ht = pt;
