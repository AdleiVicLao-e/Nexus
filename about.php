          ...
          <div class="col-lg-6 pt-5 pt-lg-0">
            ...
            <div class="row">
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                ...
                <p>By integrating innovative technology into the museum experience, we aim to educate and engage visitors in a meaningful way, fostering a deeper appreciation for Igorot culture.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">QR Code Scanning</a></h4>
          ...
          <div class="col-md-6 col-lg-4 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">Digital Artifact Guide</a></h4>
          ...
          <div class="col-md-6 col-lg-4 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">Interactive Museum Experience</a></h4>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">Mobile-Friendly Design</a></h4>
          ...
          <div class="col-md-6 col-lg-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="500">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">Enhanced Learning Experience</a></h4>
...
<script type="text/javascript"
        src="res/js/client/about.js"></script>
</body>
</html>
