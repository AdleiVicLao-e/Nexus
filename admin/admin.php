...
>>>>>>> a87577e0ffa1e0e4e6320ae2790397d870192193
                ...
                <div id="upload" class="tab-content">
                    <h3>Upload Media</h3>
                    <form action="/include/uploadMedia.php" method="post" value="" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="media-upload">Select Media:</label>
                            <input type="file" id="media-upload" name="media-upload" required>
                        </div>
                        <button type="submit" name="upload" value="general">Upload Media</button>
                    </form>
                </div>
                    ...
                    const donutChart = new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                data: data.counts,
                                backgroundColor: ["#ea5545", // Color 1
                                    "#f46a9b", // Color 2
                                    "#ef9b20", // Color 3
                                    "#edbf33", // Color 4
                                    "#ede15b", // Color 5
