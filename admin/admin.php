        ...
        <div class="right-container">
            <div class="artifacts">
                ...
                <br>
                            ...
                            <!-- Start of Archive div -->
                            <div class="archives">
                                <h2>Archive</h2>
                                    <div class="tabs">
                                        <div class="tab active" onclick="openTab('artifact-archive')">
                                            Artifact Archives
                                            <i class="fas fa-archive"></i>
                                        </div>
                                        <div class="tab" onclick="openTab('group-archive')">
                                            Group Archives
                                            <i class="fas fa-users"></i>
                                        </div>
                                    </div>

                                    <!-- Artifact Archives Tab -->
                                    <div id="artifact-archive" class="tab-content active" style="background-color: #ffffff; margin-top: -20px;">
                                        <div class="form-container">
                                            <form action="" method="post">
                                                ...
                                                <div class="arch-delete-button-container" id="button-container-section">
                                                    <button type="button" class="btn" onclick="openArchSectionModal()">Unarchive</button>
                                    ...
                                    <!-- Group Archives Tab -->
                                    <div id="group-archive" class="tab-content" style="background-color: #ffffff; margin-top: -20px;">
                                        <div class="form-container">
                                            <form action="" method="post">
                                                ...
                                                <div class="arch-delete-button-container" id="button-container-catalog">
                                                    <button type="button" name="action" value="edit_catalog" class="btn" onclick="openArchCatalogModal()">Unarchive</button>
                                                ...
                                                <div class="arch-delete-button-container" id="button-container-subcatalog">
                                                    <button type="button" name="action" value="create_subcatalog" onclick="openArchSubcatalogModal()" class="btn">Unarchive</button>
