    ...
    <div id="wrapper">
        ...
        <section class="hero">
            <div class="hero-content">
                ...
                <p>Explore the fascinating history, culture, and traditions of the Igorot people through captivating
                    exhibits and interactive experiences.</p>
        ...
        <section id="qr-code-introduction" class="qr-code-intro">
            <div class="container">
                ...
                <p>
                    Our innovative application allows you to explore the museum's artifacts through QR code scanning,
                    enhancing your experience and understanding of Igorot culture.
                </p>
        ...
        <section id="b-roll" class="b-roll">
            <div class="container">
                ...
                <p>Immerse yourself in the vibrant culture of the Igorot people! Experience the rhythm and movements
                    that bring these rich traditions to life.</p>
                <video controls width="100%" poster="assets/img/poster.png">
        ...
        <section id="main-content">
            <div class="container">
                ...
                <p>
                    At the SLU Museum of Igorot Cultures and Arts, embark on a captivating journey through the rich
                    heritage of the Igorot people. Our museum is a vibrant hub that showcases the diverse traditions,
                    art forms, and historical narratives defining the Igorot identity.
                </p>
                <img src="/assets/img/img1.png" alt="Description of image 1">

                <p>
                    Explore our curated exhibits featuring stunning artifacts, traditional clothing, and intricate
                    crafts that reflect the creativity of the Igorot community. Each piece, from ancient tools to
                    contemporary art, tells a story about the daily lives and values of our ancestors.
                </p>
                <img src="/assets/img/img2.png" alt="Description of image 2">

                <p>
                    Join us for workshops, educational programs, and guided tours led by staff passionate about sharing
                    Igorot culture. Our museum fosters understanding and appreciation of the rich tapestry of Igorot
                    heritage for students, residents, and visitors alike.
                </p>
                <img src="/assets/img/img3.png" alt="Description of image 3">
                <p>
                    We look forward to welcoming you to our museum, where each visit inspires curiosity and deepens your
                    understanding of beautiful Igorot traditions. Discover the stories that connect us and celebrate the
                    vibrant culture that continues to thrive today!
                </p>
            </div>
        </section>
</body>
    ...
    <div class="container">
        <div class="footer-logo-block">
            <a href="https://www.facebook.com/slumuseum" class="footer-logo">
                ...
                <p class="copyright" style="font-size: 15px">© 2024 SLU Museum of Igorot Cultures and Arts. All Rights
                    Reserved.</p>
        </div>
        <div class="clearfix"></div>
    </div>
...
if (guestSession) {
    ...
    document.getElementById("welcome").innerHTML = "Welcome! " + guestSession;
} else {
